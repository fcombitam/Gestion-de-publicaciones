...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'admin.users.uptade'])->syncRoles([$role1]);
        ...
        Permission::create(['name' => 'admin.posts.editable'])->syncRoles([$role2]);
        Permission::create(['name' => 'admin.posts.destroy'])->syncRoles([$role1,$role2]);

        Permission::create(['name' => 'admin.posts.solicitudes'])->syncRoles([$role1]);
